function simulate ()
  ...
  if (N!=0)
    plot(x_low,y_low,'s', 'MarkerFaceColor', 'none', 'MarkerEdgeColor', 'none','MarkerSize',10);
  end;
  if (M!=0)
  ...
  h1=rectangle ("Position", [14, -2, 12,12], "Curvature", [0, 0]);
  set (h1, "FaceColor", [0.5, 0.5, 0.5],'EdgeColor',[0.5, 0.5, 0.5]);
  line([20,20],[-2,15], 'Color', 'white', 'LineStyle', '--', 'LineWidth', 3);
